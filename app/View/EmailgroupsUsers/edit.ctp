...
<?php echo $this->Form->create('EmailgroupsUser'); ?>
	<fieldset>
		<legend><?php echo __('Edit Emailgroups User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EmailgroupsUser.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EmailgroupsUser.id'))); ?></li>
