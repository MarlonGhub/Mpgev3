...
<div class="container">		
	<div class="row">            
        <div class="col-md-9">
            ...
            <div class="panel-group acc-v1 margin-bottom-40" id="accordion">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            After logging into the job management system, click on the "Upload Job" navigation link on the top of the screen. This will take the user to the "Create New Job" page while automatically assigning a job ID to the request (the ID will only be processed upon pressing the "Submit" button at the bottom of the order form). Fill out the appropriate information, including a name for the job, the due date, envelope type, and any needed data or art files.<br/>
                            Next, should the need arise for notifications to be sent out to other users, specify the user (or user group), along with options such as whether the user notified is required for proof approval. Additional notifications can be added on-screen by pressing the "Add Notification" button.<br/>
                            Any further notes, comments, or clarifications can be added to the provided "Job Notes" box and will be attached to the order as it is processed.<br/>
                            Finally, click the "Submit" button to submit the order. If, for any reason, the user would like to start over the order from scratch, press the "Clear" button to remove all inputted information on the page (except for data files).<br/>
                            <small style="float:right;"><i>- Posted by</i><b> Admin </b><i>(June 20, 2014)</i></small>.
                        </div>
                    </div>
                </div>
			...
			<!-- Other Questions -->
            <div class="headline"><h2>User Questions</h2></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <p class="list-unstyled margin-bottom-30">
...
<script type="text/javascript" src="../css/unify/assets/plugins/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="../css/unify/assets/plugins/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript" src="../css/unify/assets/plugins/bootstrap/js/bootstrap.min.js"></script> 
<script type="text/javascript" src="../css/unify/assets/plugins/hover-dropdown.min.js"></script> 
<script type="text/javascript" src="../css/unify/assets/plugins/back-to-top.js"></script>
<!-- JS Page Level -->           
<script type="text/javascript" src="../css/unify/ssets/js/app.js"></script>
