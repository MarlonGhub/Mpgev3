...
<?php echo $this->Form->create('Envelope'); ?>
	<fieldset>
		<legend><?php echo __('Edit Envelope'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Envelope.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Envelope.id'))); ?></li>
