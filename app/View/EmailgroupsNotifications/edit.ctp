...
<?php echo $this->Form->create('EmailgroupsNotification'); ?>
	<fieldset>
		<legend><?php echo __('Edit Emailgroups Notification'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EmailgroupsNotification.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EmailgroupsNotification.id'))); ?></li>
